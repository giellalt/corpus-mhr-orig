...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Марий Эл республикын конституцийже'"/>
    <!--
    ...
    <!-- Automatically filled in by CorpusTools -->
    <xsl:variable name="mainlang" select="'mhr'"/>
    ...
    <parallel_text location="konstitucijagornaja2015bezvydelenija.doc" xml:lang="mrj"/>
</xsl:variable>
